                ...
                <div class="xl:w-3/5 p-16">
                    ...
                    <div class="flex items-start flex-col md:flex-row font-normal mb-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="email" id="email" name="email" placeholder="prenom@nom.fr *" class="w-1/2 bg-gray2 rounded-lg px-8 py-4"/>
                            <label for="phone" ></label>
                            <input type="phone" id="phone" name="phone" placeholder="Téléphone *" class="w-[49%] ml-1  bg-gray2 rounded-lg px-8 py-4"/>
                        </div>
                        <div class="space-y-1">
